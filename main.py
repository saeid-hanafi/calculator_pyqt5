...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("Python Docs/Step4-Python/43-PyQt5/Files/back.png"), QtGui.QIcon.Normal,
                        QtGui.QIcon.Off)
        ...
        self.btn_dot.clicked.connect(lambda: self.press_number("."))

        self.btn_minus.clicked.connect(lambda: self.press_operator("-"))
        self.btn_multiply.clicked.connect(lambda: self.press_operator("*"))
        self.btn_div.clicked.connect(lambda: self.press_operator("/"))
    ...
    def press_number(self, number):
        exp = self.le_result.text()
        self.le_result.setText(exp + number)

    def press_operator(self, operator):
        exp = self.le_result.text()
        self.le_result.setText(exp + operator)
    ...
    def press_back(self):
        ...
        if len(exp) > 0:
            exp_new = exp[:-1]
            self.le_result.setText(exp_new)
    ...
    def equal_press(self):
        try:
            ...
            self.le_result.setText("invalid Parameters!Please Clear And Type Again!")
